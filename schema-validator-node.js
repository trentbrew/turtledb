/**
 * Validates a TurtleDB schema configuration for correctness and consistency - Node.js version
 * Throws an error if the schema is invalid.
 */
export function validateSchema(schema) {
  if (!schema || typeof schema.node_types !== 'object' || typeof schema.edge_types !== 'object') {
...
function validateEdgeConnection(edgeTypeName, side, config, existingNodeNames) {
  if (!config) {
...
function validateAccessControl(entityName, accessControl) {
  ...
  if (accessControl.roles !== undefined) {
    if (typeof accessControl.roles !== 'object' || accessControl.roles === null) {
