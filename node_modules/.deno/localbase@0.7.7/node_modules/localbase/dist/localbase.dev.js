...
},{"./localbase/localbase":19}],5:[function(require,module,exports){
"use strict";
...
},{"../api-utils/reset":6,"../utils/logger":21}],6:[function(require,module,exports){
"use strict";
...
},{"../utils/logger":21,"./reset":6}],9:[function(require,module,exports){
"use strict";
...
},{"../api-utils/reset":6,"../utils/logger":21}],10:[function(require,module,exports){
"use strict";
...
exports["default"] = add;
var _orderedUuid = _interopRequireDefault(require("ordered-uuid"));
...
function add(data, keyProvided) {
  ...
  if (!this.userErrors.length) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      if (!keyProvided) {
        key = _orderedUuid["default"].generate();
      } else {
        key = keyProvided;
      }
...
},{"../../api-utils/error":5,"../../api-utils/showUserErrors":8,"../../api-utils/success":9,"ordered-uuid":24}],11:[function(require,module,exports){
"use strict";
...
},{"../../api-utils/error":5,"../../api-utils/selectionLevel":7,"../../api-utils/showUserErrors":8,"../../api-utils/success":9,"../../utils/isSubset":20,"../../utils/logger":21}],12:[function(require,module,exports){
"use strict";
...
function get() {
  ...
  this.getCollection = function () {
    ...
    var colSelectionCriteria = options.filter;
    ...
    return _this.lf[collectionName].iterate(function (value, key) {
      ...
      if (colSelectionCriteria) {
        if ((0, _isSubset["default"])(value, colSelectionCriteria)) {
...
},{"../../api-utils/reset":6,"../../api-utils/selectionLevel":7,"../../api-utils/showUserErrors":8,"../../utils/isSubset":20,"../../utils/logger":21}],13:[function(require,module,exports){
"use strict";
...
},{"../../api-utils/error":5,"../../api-utils/selectionLevel":7,"../../api-utils/showUserErrors":8,"../../api-utils/success":9,"../../utils/isSubset":20,"../../utils/logger":21}],14:[function(require,module,exports){
"use strict";
...
},{"../../api-utils/error":5,"../../api-utils/showUserErrors":8,"../../api-utils/success":9,"../../utils/isSubset":20,"../../utils/logger":21,"../../utils/updateObject":22}],15:[function(require,module,exports){
"use strict";
...
},{"localforage":23}],18:[function(require,module,exports){
"use strict";
...
// Localbase
var Localbase = exports["default"] = /*#__PURE__*/_createClass(function Localbase(dbName) {
...
},{"./api/actions/add":10,"./api/actions/delete":11,"./api/actions/get":12,"./api/actions/set":13,"./api/actions/update":14,"./api/filters/limit":15,"./api/filters/orderBy":16,"./api/selectors/collection":17,"./api/selectors/doc":18}],20:[function(require,module,exports){
"use strict";
...
},{"buffer":2,"uuid":25}],25:[function(require,module,exports){
var v1 = require('./v1');
var v4 = require('./v4');
...
},{"./lib/bytesToUuid":26,"./lib/rng":27}]},{},[4])(4)
});
