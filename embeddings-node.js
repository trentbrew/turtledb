/**
 * Real embeddings implementation using @xenova/transformers - Pure Node.js
 ...
 */
export async function isRealEmbeddingsAvailable() {
  try {
    await initEmbeddingPipeline()
    return true
  } catch (error) {
    console.warn('Real embeddings not available, falling back to deterministic embeddings')
    return false
  }
}
